...
const todosPersonajes = async(state) =>{
    ...
    const peticion = await axios.get("https://api.attackontitanapi.com/characters?occupation=Warrior")
    const peticion = await axios.get("https://api.attackontitanapi.com/titans")
